...
#define DISPATCH_CHANNELS(M, FUNC, GRID, BLOCK, ...)                             \
[&] {                                                               \
    switch (M) {                                                    \
    case 1:  FUNC<1><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
    case 2:  FUNC<2><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 3:  FUNC<3><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 4:  FUNC<4><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 5:  FUNC<5><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 6:  FUNC<6><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 7:  FUNC<7><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 8:  FUNC<8><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 9:  FUNC<9><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                          \
	case 10: FUNC<10><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 11: FUNC<11><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 12: FUNC<12><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 13: FUNC<13><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 14: FUNC<14><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 15: FUNC<15><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 16: FUNC<16><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	case 17: FUNC<17><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
    case 18: FUNC<18><<<GRID,BLOCK>>>(__VA_ARGS__);  break;                         \
	...
	float* out_others)
{
	...
	DISPATCH_CHANNELS(M, renderCUDA, grid, block,
		ranges,
		point_list,
		W, H,
		focal_x, focal_y,
	...
	bool prefiltered)
{
	...
	DISPATCH_CHANNELS(M, preprocessCUDA, (P+255)/256, 256,
		P, D, M,
		means3D,
		scales,
		scale_modifier,
